...
const CircleDetailDrawer = lazy(() => import('../components/CircleDetailDrawer'));
const EditBookmarkNoteDrawer = lazy(() => import('../components/EditBookmarkNoteDrawer'));
const SeeBookmarkNoteDrawer = lazy(() => import('../components/SeeBookmarkNoteDrawer'));
